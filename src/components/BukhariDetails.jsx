...
const BukhariDetails = ({ route, navigation }) => {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`https://cdn.jsdelivr.net/gh/aashif000/DB-for-Q-H@main/bukhari/${chapterId}.json`);
