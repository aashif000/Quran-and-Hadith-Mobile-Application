...
import Trimidhi from './Trimidhi';

import { Ionicons } from '@expo/vector-icons';

const TrimidhiDetails = ({ route, navigation }) => {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(`https://cdn.jsdelivr.net/gh/aashif000/DB-for-Q-H@main/trimidhi/${chapterId}.json`);
...
export default TrimidhiDetails;
